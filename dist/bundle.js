...
function addImage(URL) {
  ...
  img.src = URL;
  (0, _jquery.default)(element).appendTo((0, _jquery.default)("body"));
  (0, _jquery.default)(img).appendTo((0, _jquery.default)("body"));
}
...
function getImageURL(input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      (0, _jquery.default)('#blah').attr('src', e.target.result);
    };
